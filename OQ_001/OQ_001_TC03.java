...
public class OQ_001_TC03 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_001 Test case 3: TC-03.01")
	...
	@Test(priority = 2, description = "OQ_001 Test case 3: TC-03.02")
	@Step("Step 2. Click on New button, new participant page is displayed")
	@Severity(SeverityLevel.BLOCKER)
	...
	@Test(priority = 3, description = "OQ_001 Test case 3: TC-03.03")
	@Step("Step 3. Select Physician, then click continue button")
	@Severity(SeverityLevel.BLOCKER)
	...
	@Test(priority = 4, description = "OQ_001 Test case 3: TC-03.04")
	...
	@Test(priority = 5, description = "OQ_001 Test case 3: TC-03.05")
	...
	@Test(priority = 6, description = "OQ_001 Test case 3: TC-03.06")
	...
	@Test(priority = 7, description = "OQ_001 Test case 3: TC-03.07")
	...
	@Test(priority = 8, description = "OQ_001 Test case 3: TC-03.08")
	@Step("Step 8. Input participant information as request, click save button, The information presented reflects the information entered ")
	@Severity(SeverityLevel.BLOCKER)
