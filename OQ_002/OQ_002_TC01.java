...
public class OQ_002_TC01 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_002 Test case 1: TC-01.01")
	...
	@Test(priority = 2, description = "OQ_002 Test case 1: TC-01.02")
	...
	@Test(priority = 3, description = "OQ_002 Test case 1: TC-01.03")
	...
	@Test(priority = 4, description = "OQ_002 Test case 1: TC-01.04")
	...
	public void Ts0104(Method method) {
		...
		Assert.assertTrue(super.isTextShowing(patientPage.getSalutation()));
	}	
	
	@Test(priority = 5, description = "OQ_002 Test case 1: TC-01.05")
	@Step("Step 5. Confirm that the details information is properly displayed")
	@Severity(SeverityLevel.BLOCKER)
    @Description("Confirm that the details information is properly displayed")
	public void Ts0105(Method method) {
		startTest(method.getName(), "Confirm that the details information is properly displayed");
		Map<String, String> physician = new HashMap<String, String>();
		physician = patientPage.getPhysicianInformation();
		for (String name: physician.keySet()) {
		    String key = name.toString();
		    String value = physician.get(name).toString();
		    Reporter.log("The details of Physician are: " + key + " " + value, true);
		}
		Assert.assertTrue(physician.size()>0);
	}	
