...
public class OQ_002_TC02 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_002 Test case 2: TC-02.01")
	...
	@Test(priority = 2, description = "OQ_002 Test case 2: TC-02.02")
	...
	@Test(priority = 3, description = "OQ_002 Test case 2: TC-02.03")
	...
	@Test(priority = 4, description = "OQ_002 Test case 2: TC-02.04")
	...
	@Test(priority = 5, description = "OQ_002 Test case 2: TC-02.05")
	...
	public void Ts0205(Method method) {
		...
		List <String> titleList = new ArrayList<String>();
		boolean result;
		String [] fields = {"Physician Information", "Communication Information", "Additional Information", "CSAN Pronto", "Legacy Fields", "System Information"};
