...
public class OQ_004_TC02 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_004 Test case 2: TC-02.01")
	...
	@Test(priority = 2, description = "OQ_004 Test case 2: TC-02.02")
	...
	@Test(priority = 3, description = "OQ_004 Test case 2: TC-02.03")
	...
	@Test(priority = 4, description = "OQ_004 Test case 2: TC-02.04")
	...
	@Test(priority = 5, description = "OQ_004 Test case 2: TC-02.05")
	...
	@Test(priority = 6, description = "OQ_004 Test case 2: TC-02.06")
	...
	@Test(priority = 7, description = "OQ_004 Test case 2: TC-02.07")
	...
	public void Ts0207(Method method) {
		...
		editParticipantsPage.newInstitution("Royal Victoria Hospital", "(514) 111-3958", "(514) 111-3985", "Quebec East", "French", "RVH Reception", "Montreal", "Québec", "H3A 1A1");
		homePage.clickOnSaveBtn();
		Assert.assertTrue(super.isTextShowing("Participant Detail"));
	}
	
	@Test(priority = 8, description = "OQ_004 Test case 2: TC-02.08")
	...
	@Test(priority = 9, description = "OQ_004 Test case 2: TC-02.09")
