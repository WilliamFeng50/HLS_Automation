...
public class OQ_006_TC01 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_006 Test case 1: TC-01.01")
	...
	@Test(priority = 2, description = "OQ_006 Test case 1: TC-01.02")
	...
	@Test(priority = 3, description = "OQ_006 Test case 1: TC-01.03")
	...
	@Test(priority = 4, description = "OQ_006 Test case 1: TC-01.04")
	@Step("Step 4. Scroll down to the Participants section, Click on Edit active Institution")
	@Severity(SeverityLevel.BLOCKER)
    @Description("Scroll down to the Participants section, Click on Edit active Institution, Patient Participant Edit page is displayed")
	public void Ts0104(Method method) {
		startTest(method.getName(), "Scroll down to the Participants section, Click on Edit active Institution, Patient Participant Edit page is displayed");
		homePage.moveToSectionForm("Participants and LCCs");
		patientPage.editActiveInstitution();
		Assert.assertTrue(super.isTextShowing("Patient Participant Edit"));
	}	
	
	@Test(priority = 5, description = "OQ_006 Test case 1: TC-01.05")
