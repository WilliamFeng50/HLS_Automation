...
public class OQ_007_TC01 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_007 Test case 1: TC-01.01")
	...
	@Test(priority = 2, description = "OQ_007 Test case 1: TC-01.02")
	...
	@Test(priority = 3, description = "OQ_007 Test case 1: TC-01.03")
	@Step("Step 3. Select record type as Pharmacy, click on continue")
	@Severity(SeverityLevel.BLOCKER)
	@Description("Select record type as Pharmacy, click on continue, the Participant edit page is displayed")
	public void Ts0103(Method method) {
		startTest(method.getName(), "Select record type as Pharmacy, click on continue, the Participant edit page is displayed");
	...
	@Test(priority = 4, description = "OQ_007 Test case 1: TC-01.04")
	...
	@Test(priority = 5, description = "OQ_007 Test case 1: TC-01.05")
	...
	@Test(priority = 6, description = "OQ_007 Test case 1: TC-01.06")
	@Severity(SeverityLevel.NORMAL)
	...
	@Test(priority = 7, description = "OQ_007 Test case 1: TC-01.07")
	...
	@Test(priority = 8, description = "OQ_007 Test case 1: TC-01.08")
	...
	@Test(priority = 9, description = "OQ_007 Test case 1: TC-01.09")
	...
	@Test(priority = 10, description = "OQ_007 Test case 1: TC-01.10")
	...
	@Test(priority = 11, description = "OQ_007 Test case 1: TC-01.11")
	...
	public void Ts0111(Method method) {
		...
		editParticipantsPage.newPharmacy("Pharmaprix 119739", "119739", "Institution", "390 Ste-Catherine", "Montreal", "Quebec", "H3B 1A1", "English", "Fax", "5141117070", "5141113958", "DR.", "Georges", "Kant");
		homePage.clickOnSaveBtn();
		Assert.assertTrue(super.isTextShowing("Participant Detail"));
	}
	
	@Test(priority = 12, description = "OQ_007 Test case 1: TC-01.12")
	...
	@Test(priority = 13, description = "OQ_007 Test case 1: TC-01.13")
	...
	@Test(priority = 14, description = "OQ_007 Test case 1: TC-01.14")
