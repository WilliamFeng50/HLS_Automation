...
public class OQ_008_TC01 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_008 Test case 1: TC-01.01")
	...
	@Test(priority = 2, description = "OQ_008 Test case 1: TC-01.02")
	...
	@Test(priority = 3, description = "OQ_008 Test case 1: TC-01.03")
	...
	@Test(priority = 4, description = "OQ_008 Test case 1: TC-01.04")
	@Step("Step 4. Scroll down to the Participants section, hover over the pharmacy's name")
	@Severity(SeverityLevel.BLOCKER)
    @Description("Scroll down to the Participants section, hover over the pharmacy's name, the popup of pharmacy's details are displayed")
	public void Ts0104(Method method) {
		startTest(method.getName(), "Scroll down to the Participants section, hover over the pharmacy's name, the popup of pharmacy's details are displayed");
	...
	@Test(priority = 5, description = "OQ_008 Test case 1: TC-01.05")
