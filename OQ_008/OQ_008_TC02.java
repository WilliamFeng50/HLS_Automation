...
public class OQ_008_TC02 extends BaseTest {
	ParticipantsPage participantsPage;
	String participant = "CARERX EDMONTON";
	...
	@Test(priority = 1, description = "OQ_008 Test case 2: TC-02.01")
	...
	@Test(priority = 2, description = "OQ_008 Test case 2: TC-02.02")
	...
	@Test(priority = 3, description = "OQ_008 Test case 2: TC-02.03")
	...
	@Test(priority = 4, description = "OQ_008 Test case 2: TC-02.04")
	...
	public void Ts0204(Method method) {
		...
		boolean result;
		String [] titles = {"Patients (Pharmacy)", "Locations", "Additional Location Access",  "Scheduled Reports", "Devices (Pharmacy)", "Activity History", "Participant History"};
		titleList = participantsPage.getRelatedTitleList();
		result = titleList.equals(Arrays.asList(titles));
		Assert.assertTrue(result);
	}
	
	@Test(priority = 5, description = "OQ_008 Test case 2: TC-02.05")
