...
@Feature("OQ_008 Test cases")
public class OQ_008_TC03 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_008 Test case 3: TC-03.01")
	...
	@Test(priority = 2, description = "OQ_008 Test case 3: TC-03.02")
	...
	@Test(priority = 3, description = "OQ_008 Test case 3: TC-03.03")
	...
	@Test(priority = 4, description = "OQ_008 Test case 3: TC-03.04")
	@Step("step 4. Scroll down to the Participants section, click the Pharmacy's name")
	@Severity(SeverityLevel.BLOCKER)
	@Description("Scroll down to the Participants section, click on the Pharmacy's name, the Participant page is displayed")
	public void Ts0304(Method method) {
		startTest(method.getName(), "Scroll down to the Participants section, click on the Pharmacy's name, the Participant page is displayed");
		patientPage.clickSubsectionDisplayBtn("Participants");
		patientPage.clickOnParticipantLink("Pharmacy");
		Assert.assertTrue(super.isTextShowing("Participant Detail"));
	}
	
	@Test(priority = 5, description = "OQ_008 Test case 3: TC-03.05")
	...
	public void Ts0305(Method method) {
		...
		boolean result;
		String [] fields = {"Pharmacy Coordinates", "Additional Information", "CSAN Pronto", "Pharmacy Contact Information", "Legacy Fields", "System Information"};
		titleList = participantsPage.getFieldsList();
		result = titleList.equals(Arrays.asList(fields));
		Assert.assertTrue(result);
	}

	@Test(priority = 6, description = "OQ_008 Test case 3: TC-03.06")
	...
	public void Ts0306(Method method) {
		...
		String [] labels = {"Name", "Pharmacy License #", "Pharmacy Type", "Address 1", "City", "Province", "Postal Code", "Communication Language", " Phone", "Fax", "Salutation", "First Name", "Last Name" };
