...
public class OQ_010_TC01 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_010 Test case 1: TC-01.01")
	...
	@Test(priority = 2, description = "OQ_010 Test case 1: TC-01.02")
	...
	@Test(priority = 3, description = "OQ_010 Test case 1: TC-01.03")
	...
	@Test(priority = 4, description = "OQ_010 Test case 1: TC-01.04")
	...
	@Test(priority = 5, description = "OQ_010 Test case 1: TC-01.05")
	...
	@Test(priority = 6, description = "OQ_010 Test case 1: TC-01.06")
	...
	@Test(priority = 7, description = "OQ_010 Test case 1: TC-01.07")
	...
	public void Ts0107(Method method) {
		...
		editParticipantsPage.newLaboratory("Alpha Laboratories", "Alpha Laboratories", "English", "Telephone", "4161111568", "4161111548", "MR.", "Michael", "Walker");
		homePage.clickOnSaveBtn();
		Assert.assertTrue(super.isTextShowing("Participant Detail"));
	}
	
	@Test(priority = 8, description = "OQ_010 Test case 1: TC-01.08")
	...
	@Test(priority = 13, description = "OQ_010 Test case 1: TC-01.13")
	...
	@Test(priority = 14, description = "OQ_010 Test case 1: TC-01.14")
