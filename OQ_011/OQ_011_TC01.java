...
public class OQ_011_TC01 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_011 Test case 1: TC-01.01")
	...
	@Test(priority = 2, description = "OQ_011 Test case 1: TC-01.02")
	...
	@Test(priority = 3, description = "OQ_011 Test case 1: TC-01.03")
	...
	@Test(priority = 4, description = "OQ_011 Test case 1: TC-01.04")
	...
	public void Ts0104(Method method) {
		...
		homePage.hoverOverLink("Laboratory");
		Assert.assertTrue(super.isTextShowing("Address 1"));
	}	
	
	@Test(priority = 5, description = "OQ_011 Test case 1: TC-01.05")
	...
	public void Ts0105(Method method) {
		...
		institution = patientPage.getLaboratoryInformation();
