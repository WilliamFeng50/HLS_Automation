...
public class OQ_013_TC02 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_013 Test case 2: TC-02.01")
	...
	@Test(priority = 2, description = "OQ_013 Test case 2: TC-02.02")
	...
	@Test(priority = 3, description = "OQ_013 Test case 2: TC-02.03")
	...
	@Test(priority = 4, description = "OQ_013 Test case 2: TC-02.04")
	...
	@Test(priority = 5, description = "OQ_013 Test case 2: TC-02.05")
	...
	@Test(priority = 6, description = "OQ_013 Test case 2: TC-02.06")
	...
	@Test(priority = 8, description = "OQ_013 Test case 2: TC-02.09")
	...
	@Test(priority = 9, description = "OQ_013 Test case 2: TC-02.08")
	...
	@Test(priority = 10, description = "OQ_013 Test case 2: TC-02.10")
	...
	@Test(priority = 11, description = "OQ_013 Test case 2: TC-02.11")
	...
	public void Ts0211(Method method) {
		...
		editParticipantsPage.newLCC("MR.","Karim", "Smith", "French", "Telephone", "5141119090", "5141114000","Karim Smith");
		homePage.clickOnSaveBtn();
		Assert.assertTrue(super.isTextShowing("Participant Detail"));
	}
	
	@Test(priority = 12, description = "OQ_013 Test case 2: TC-02.12")
	...
	@Test(priority = 13, description = "OQ_013 Test case 2: TC-02.13")
	...
	@Test(priority = 14, description = "OQ_013 Test case 2: TC-02.14")
