...
public class OQ_019_TC08 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_019 Test case 8: TC-08.01")
	@Step("Step 1: Input Test Date, WBC, ANC, GRC")
	@Severity(SeverityLevel.BLOCKER)
    @Description("Input Test Date, WBC 32, ANC 24, GRC 24, confirm the values have ben autocompleted for ANC%:75, GRC%:75")
	public void Ts0801(Method method) {
		startTest(method.getName(), "Input Test Date, WBC 32, ANC 24, GRC 24, confirm the values have ben autocompleted for ANC%:75, GRC%:75");
		String wbc = "32";
		String anc = "24";
		String ancP = "";
		String grc = "24";
	...
	@Test(priority = 2, description = "OQ_019 Test case 8: TC-08.02")
	...
	@Test(priority = 3, description = "OQ_019 Test case 8: TC-08.03")
	...
	@Test(priority = 4, description = "OQ_019 Test case 8: TC-08.04")
	...
	@Test(priority = 5, description = "OQ_019 Test case 8: TC-08.05")
