...
public class OQ_019_TC14 extends BaseTest {
    ...
    @Description("Input Test Date, WBC 35, ANC 28, click on save button, confirm the values have ben autocompleted for ANC%:80")
	public void Ts0801(Method method) {
		startTest(method.getName(), "Input Test Date, WBC 35, ANC 28, click on save button, confirm the values have ben autocompleted for ANC%:80");
		String wbc = "35";
		String anc = "28";
		String ancP = "";
		String grc = "";
	...
	@Severity(SeverityLevel.BLOCKER)
    @Description("Input Test Date, WBC 9, ANC 8, GRC 8, click on save button, confirm the error message is showing")
	public void Ts1002(Method method) {
		startTest(method.getName(), "Input Test Date, WBC 9, ANC 8, GRC 8, click on save button, confirm the error message is showing");
		String wbc = "9";
		String anc = "8";
		String ancP = "";
		String grc = "8";
	...
	public void Ts1004(Method method) {
		...
		Assert.assertTrue(wbc.equals("9.00") && anc.equals("8.00" )&& grc.equals("8.00") && lastTestDate.equals(super.getToday("M/d/yyyy")));
	}	
