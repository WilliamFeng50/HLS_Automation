...
public class OQ_060_TC01 extends BaseTest {
	...
	@Test(priority = 5, description = "OQ_060 Test case 1: TC-01.05")
	@Step("Step 5. Click the Reset Password button")
	@Severity(SeverityLevel.NORMAL)
	@Description("Click the Reset Password button, the temporary password is displayed")
	public void Ts0105(Method method) {
		startTest(method.getName(), "Click the Reset Password button, the temporary password is displayed");
	...
	@Test(priority = 6, description = "OQ_060 Test case 1: TC-01.06")
	@Step("Step 6. Navigate to the portal login page, login with the username and temporary password")
	@Severity(SeverityLevel.NORMAL)
	...
	@Test(priority = 7, description = "OQ_060 Test case 1: TC-01.07")
	@Step("Step 7. Enter the new password, click on save button")
	@Severity(SeverityLevel.BLOCKER)
