...
public class OQ_068_TC02 extends BaseTest {
	String patient = "2018042503 BJ";
	String testResultID = "";
	String alertNumber = "";
	...
	@Test(priority = 1, description = "OQ_068 Test case 2: TC-02.01")
	...
	@Test(priority = 2, description = "OQ_068 Test case 2: TC-02.02")
	...
	@Test(priority = 3, description = "OQ_068 Test case 2: TC-02.03")
	...
	@Test(priority = 4, description = "OQ_068 Test case 2: TC-02.04")
	@Step("step 4. Scroll down to the Test Results section, indicates a Flashing Yellow alert and click on the Test Result ID")
	@Severity(SeverityLevel.BLOCKER)
	@Description("Scroll down to the Test Results section, indicates a Flashing Yellow alert and click on the Test Result ID, the test results page is displayed")
	public void Ts0204(Method method) {
		startTest(method.getName(), "Scroll down to the Test Results section, indicates a Flashing Yellow alert and click on the Test Result ID, the test results page is displayed");
		homePage.moveToSectionForm("Test Results (Units of measure 10^9/L)");
		testResultID = patientPage.getTestResultIDByAlert(FlashingYellow);
		homePage.clickOnTableLink(testResultID);
		Assert.assertTrue(super.isTextShowing("Test Result Detail"));
	}
	
	@Test(priority = 5, description = "OQ_068 Test case 2: TC-02.05")
	...
	@Test(priority = 6, description = "OQ_068 Test case 2: TC-02.06")
	...
	public void Ts0206(Method method) {
		...
		Assert.assertTrue(type.equalsIgnoreCase("Flashing Yellow"));
	}
}
