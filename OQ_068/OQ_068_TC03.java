...
public class OQ_068_TC03 extends BaseTest {
	String patient = "1992010203 LB";
	String testResultID = "";
	String alertNumber = "";
	...
	@Test(priority = 1, description = "OQ_068 Test case 3: TC-03.01")
	...
	@Test(priority = 2, description = "OQ_068 Test case 3: TC-03.02")
	...
	@Test(priority = 3, description = "OQ_068 Test case 3: TC-03.03")
	...
	@Test(priority = 4, description = "OQ_068 Test case 3: TC-03.04")
	@Step("step 4. Scroll down to the Test Results section, indicates a Red alert and click on the Test Result ID")
	@Severity(SeverityLevel.BLOCKER)
	@Description("Scroll down to the Test Results section, indicates a Red alert and click on the Test Result ID, the test results page is displayed")
	public void Ts0304(Method method) {
		startTest(method.getName(), "Scroll down to the Test Results section, indicates a Red alert and click on the Test Result ID, the test results page is displayed");
		homePage.moveToSectionForm("Test Results (Units of measure 10^9/L)");
		testResultID = patientPage.getTestResultIDByAlert(RedAlert);
		homePage.clickOnTableLink(testResultID);
		Assert.assertTrue(super.isTextShowing("Test Result Detail"));
	}
	
	@Test(priority = 5, description = "OQ_068 Test case 3: TC-03.05")
	...
	@Test(priority = 6, description = "OQ_068 Test case 3: TC-03.06")
	...
	public void Ts0306(Method method) {
		...
		Assert.assertTrue(type.equalsIgnoreCase("Red"));
	}
}
