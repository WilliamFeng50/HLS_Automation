...
public class OQ_105_TC08 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_105 Test case 8: TC-08.01")
	...
	@Test(priority = 2, description = "OQ_105 Test case 8: TC-08.02")
	...
	@Test(priority = 3, description = "OQ_105 Test case 8: TC-08.03")
	...
	@Test(priority = 4, description = "OQ_105 Test case 8: TC-08.04")
	...
	@Test(priority = 5, description = "OQ_105 Test case 8: TC-08.05")
	...
	public void Ts0805(Method method) {
	...
	@Test(priority = 7, description = "OQ_105 Test case 8: TC-08.07")
	@Step("Step 7. Select eLetter Every Four Weeks")
	@Severity(SeverityLevel.BLOCKER)
    @Description("Select eLetter Every Four Weeks, the list of Target Recipients is displayed")
	public void Ts0807(Method method) {
		startTest(method.getName(), "Select eLetter Every Four Weeks, the list of Target Recipients is displayed");
		eLetterPage.selectELeter("eLetter Every Four Weeks");
		Assert.assertTrue(super.isTextShowing("Recipient Type"));
	}	
	
	@Test(priority = 8, description = "OQ_105 Test case 8: TC-08.08")
	...
	public void Ts0808(Method method) {
