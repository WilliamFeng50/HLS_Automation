...
public class OQ_123_TC11 extends BaseTest {
	String patient = "2018042503 BJ";
	String alertNumber = "A-278916";
	...
	@Test(priority = 1, description = "OQ_123 Test case 11: TC-11.01")
	...
	public void Ts1101(Method method) {
		...
		eLetterPage.selectELeter("eLetter Red");
		Assert.assertTrue(super.isTextShowing("Recipient Type"));
	}	

	@Test(priority = 2, description = "OQ_123 Test case 11: TC-11.02")
	...
	@Test(priority = 3, description = "OQ_123 Test case 11: TC-11.03")
	...
	@Test(priority = 4, description = "OQ_123 Test case 11: TC-11.04")
