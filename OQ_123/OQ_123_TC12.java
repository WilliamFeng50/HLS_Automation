...
public class OQ_123_TC12 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_123 Test case 12: TC-12.01")
	...
	public void Ts1201(Method method) {
		...
		eLetterPage.selectELeter("eLetter BEN Red");
		Assert.assertTrue(super.isTextShowing("Recipient Type"));
	}	

	@Test(priority = 2, description = "OQ_123 Test case 12: TC-12.02")
	...
	@Test(priority = 3, description = "OQ_123 Test case 12: TC-12.03")
	...
	@Test(priority = 4, description = "OQ_123 Test case 12: TC-12.04")
