...
public class OQ_123_TC13 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_123 Test case 13: TC-13.01")
	...
	public void Ts1301(Method method) {
		...
		eLetterPage.selectELeter("eLetter Yellow");
		Assert.assertTrue(super.isTextShowing("Recipient Type"));
	}	

	@Test(priority = 2, description = "OQ_123 Test case 13: TC-13.02")
	...
	@Test(priority = 3, description = "OQ_123 Test case 13: TC-13.03")
	...
	@Test(priority = 4, description = "OQ_123 Test case 13: TC-13.04")
