...
public class OQ_123_TC16 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_123 Test case 16: TC-16.01")
	...
	public void Ts1601(Method method) {
		...
		eLetterPage.selectELeter("eLetter BEN Yellow");
		Assert.assertTrue(super.isTextShowing("Recipient Type"));
	}	

	@Test(priority = 2, description = "OQ_123 Test case 16: TC-16.02")
	...
	@Test(priority = 3, description = "OQ_123 Test case 16: TC-16.03")
	...
	@Test(priority = 4, description = "OQ_123 Test case 16: TC-16.04")
