...
public class OQ_123_TC21 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_123 Test case 21: TC-21.01")
	...
	public void Ts2101(Method method) {
		...
		eLetterPage.selectELeter("eLetter Return to Green");
		Assert.assertTrue(super.isTextShowing("Recipient Type"));
	}	

	@Test(priority = 2, description = "OQ_123 Test case 21: TC-21.02")
	...
	@Test(priority = 3, description = "OQ_123 Test case 21: TC-21.03")
	...
	@Test(priority = 4, description = "OQ_123 Test case 21: TC-21.04")
	@Step("Step 4. Check the email inbox")
	@Severity(SeverityLevel.BLOCKER)
    @Description("Check the email inbox")
	public void Ts2104(Method method) {
