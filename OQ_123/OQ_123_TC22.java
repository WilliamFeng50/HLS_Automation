...
public class OQ_123_TC22 extends BaseTest {
	...
	@Test(priority = 1, description = "OQ_123 Test case 22: TC-22.01")
	...
	public void Ts2201(Method method) {
		...
		eLetterPage.selectELeter("eLetter Alert Twice a Week Special Case");
		Assert.assertTrue(super.isTextShowing("Recipient Type"));
	}	

	@Test(priority = 2, description = "OQ_123 Test case 22: TC-22.02")
	@Step("Step 2. Click on send button")
	@Severity(SeverityLevel.NORMAL)
    @Description("Click on send button")
	public void Ts2202(Method method) {
